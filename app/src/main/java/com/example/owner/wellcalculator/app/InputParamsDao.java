...
//This class is used read/write an array of InputParamsData (well parameters) from/to SQLite DB
//Internal storage is used instead of external storage
public class InputParamsDao extends SQLiteOpenHelper{

    public static final String DATABASE_NAME = "Inputs.db";
    public static final String INPUT_TABLE_NAME = "inputs";
    ...
    public InputParamsDao(Context context)
    {
    ...
    public InputParamsData[] readInputs() {
        ...
        while(!res.isAfterLast()){
            ...
            inputData[count] = new InputParamsData(name, minvalue, value, maxvalue, unit, false);
            res.moveToNext();
            count++;
        }
